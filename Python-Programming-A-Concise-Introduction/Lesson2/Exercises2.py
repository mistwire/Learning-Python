...
#%%
def multiply():
    numstr1 = float(input("Enter a number: "))
    numstr2 = float(input("Enter another number: "))
    #num1 = float(numstr1)
    #num2 = float(numstr2)
    print("Their product is ", numstr1 * numstr2)
...
"""
#%%
print(newEngland[0][1]) #list inside a list
...
def average(nlis):
    ...
    for i in nlis:
        sum += i
        avg = sum/divisor
    print('The average of', nlis,'is', avg)
